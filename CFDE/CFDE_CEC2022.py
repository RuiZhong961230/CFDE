...
def RunCFDE(func):
    ...
    np.savetxt("./CFDE_Data/CEC2022/F" + str(FuncNum) + "_" + str(DimSize) + "D.csv", All_Trial_Best, delimiter=",")
...
def main(Dim):
    ...
    for i in range(len(CEC2022)):
        FuncNum = i + 1
        RunCFDE(CEC2022[i].evaluate)


if __name__ == "__main__":
    if os.path.exists('CFDE_Data/CEC2022') == False:
        os.makedirs('CFDE_Data/CEC2022')
    for dim in [10, 20]:
        main(dim)
